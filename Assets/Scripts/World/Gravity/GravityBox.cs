...
namespace World.Gravity
{
    public class GravityBox : GravitySource
    {
        ...
        [Header("Box Settings")]
        [Tooltip("Set the boundary layer distance")]
        [SerializeField] private Vector3 boundaryDistance = Vector3.one;
        
        [Header("Inner Box Settings")]
        [Tooltip("Set the inner box distance that has full gravity")]
        [SerializeField, Min(0f)] private float innerDistance;
        [Tooltip("Set the inner box falloff distance")]
        [SerializeField, Min(0f)] private float innerFalloffDistance;
        
        [Header("Outer Box Settings")]
        [Tooltip("Set the outer box distance that has full gravity")]
        [SerializeField, Min(0f)] private float outerDistance;
        [Tooltip("Set the outer box falloff distance")]
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.matrix = Matrix4x4.TRS(cachedTransform.position, cachedTransform.rotation, Vector3.one);
